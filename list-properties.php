...
<head>
<title>All Listing Properties - Beay Real Estate Agent</title>
<meta charset="UTF-8" />
    ...
    <div class="row">
            ...
            <div class="col-lg-7">
              ...
              <option>Price</option>
                ...
                <option value="4">20,000,000 - above</option>
              </select>
            </div>
          </div>
          ...
          <div class="col-lg-12">
              <select name="property_type" class="form-control">
                ...
                <option value="Apartment">Kiwanja cha Makazi</option>
                <option value="Building">Kiwanja Cha Biashara</option>
                <option value="Office-Space">Kiwanja Cha Makazi na Biashara</option>
              </select>
              </div>
          </div>
...
<div class="row">
     ...
     <?php 
      ...
      <div class="properties">
        ...
        <span data-toggle="tooltip" data-placement="bottom" data-original-title=" "><?php echo $bed_room; ?></span> 
        <span data-toggle="tooltip" data-placement="bottom" data-original-title=" "><?php echo $liv_room; ?></span> 
        <span data-toggle="tooltip" data-placement="bottom" data-original-title=" "><?php echo $parking; ?></span> 
        <span data-toggle="tooltip" data-placement="bottom" data-original-title=" "><?php echo $kitchen; ?></span> 
        </div>
...
<p class="copyright">Copyright &copy 2022.Beay Real Estate Agent.All rights reserved | Developed By Meshapps</i></p>
