...
<head>
<title>Property Details - Beay Real Estate Agent</title>
<meta charset="UTF-8" />
    ...
    <div class="row">
          ...
          <div class="col-lg-12">
              <select name="property_type" class="form-control">
                ...
                <option value="Building">Kiwanja Cha Makazi na Biashara</option>
                <option value="Office-Space">Kiwanja Cha Biashara</option>
              </select>
              </div>
          </div>
...
<div class="well"><p class="price"><?php echo $price; ?>Tshs</p></div>
  ...
  <p class="area"><div class="well"><span class="glyphicon glyphicon-map-marker"></span> <?php echo $property_address; ?> </div></p>
    ...
    <div class="well"><span class="glyphicon glyphicon-check"></span> &nbsp; <b>Eneo - <?php echo $floor_space; ?></b></div>
